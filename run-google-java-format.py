...
gjf_version = os.getenv("GJF_VERSION", "1.5")
gjf_snapshot = os.getenv("GJF_VERSION", "")
gjf_url_base = os.getenv("GJF_VERSION", "https://github.com/google/google-java-format/releases/download/google-java-format-" + gjf_version + "/")
